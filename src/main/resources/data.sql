...
VALUES (1, 'Webzine Maker (Campusplex)', 'Antoine Dupont', 'Antoine Dupont', '12 Rue Général Fiorella', 20000,
       ...
       (3, 'Ollandini', 'Etienne Jacques', 'Gilbert Durand',
        '1 Rue Paul Colonna d''Istria', 20000, 'Ajaccio', '01 02 03 04 05', '01 02 03 04 05', 'contact@infos.fr', '', 'http://www.ollandini.fr/', 'BAC+2', 1),
...
(5, 'Communauté d''Agglomération du Pays Ajaccien (CAPA)', 'Pierre Paul', 'Pierre Paul', '18 rue Comte de Marbeuf',
       ...
       (19,
        'ESI-DGFIP d''Ajaccio', 'Didier Tresor', '', 'Immeuble Castellani Saint-Joseph', 20090, 'Ajaccio', '01 02 03 04 05', '01 02 03 04 05', 'contact@infos.fr', '', '', 'BAC+1/BAC+2', 1),
